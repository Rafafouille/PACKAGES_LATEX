	...
	%-------------------------------------------
		...
		\subsection{Dérivées et calculs différentiels}
			...
			\begin{tabular}{|p{0.35\linewidth}|p{0.3\linewidth}|p{0.3\linewidth}|}
				...
				\\\hline
					\verb!\dx,\dy,\dz,\dtheta,\dr,! \verb!\dS,\dV!		&	\dx,\dy,\dz,\dtheta,\dr,\dS,\dV			&	Diverses variables d'intégration
				\\\hline
					\verb!\dx[1],\dy[2],\dz[3],! \verb!\dtheta[4],\dr[5],! \verb!\dS[6],\dV[7]!		&		\dx[1],\dy[2],\dz[3],\dtheta[4],\dr[5], \dS[6],\dV[7]		&	Diverses variables d'intégration avec indices
				\\\hline
			\end{tabular}
