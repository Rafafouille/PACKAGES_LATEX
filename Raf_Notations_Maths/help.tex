	...
	%-------------------------------------------
		...
		\subsection{Dérivées et calculs différentiels}
			...
			\begin{tabular}{|p{0.35\linewidth}|p{0.3\linewidth}|p{0.3\linewidth}|}
				...
				\\\hline
					\verb!\dx, \dy, \dz, \dtheta,! \verb!\dr, \du, \dv, \dw, \dS,! \verb!\dV!		&	\dx, \dy, \dz, \dtheta, \du, \dv, \dw, \dr, \dS, \dV			&	Diverses variables d'intégration
				\\\hline
					\verb!\dx[1], \dy[2], \dz[3],! \verb!\dtheta[4], \dr[5],! \verb!\du[6],\dv[7], \dw[8],! \verb!\dS[9], \dV[10]!		&		\dx[1], \dy[2], \dz[3], \dtheta[4], \dr[5], \du[6], \dv[7], \dw[8], \dS[9], \dV[10]		&	Diverses variables d'intégration avec indices
				\\\hline
			\end{tabular}
