...
usepackage[noRaccourci]{Raf_Notations_Cinematique}
	...
	\begin{tabular}{|p{0.35\linewidth}|p{0.3\linewidth}|p{0.3\linewidth}|}
		\hline
			\textbf{Commandes}&\textbf{Rendus}&\textbf{Commentaires}
		\\\hline\hline
			\verb!\xt,\yt,\zt,\rt,\alphat,! \verb!\betat,\gammat,\phit! \verb!\psit,\thetat,\lambdat!	&	\xt,\yt,\zt,\rt,\alphat, \betat,\gammat,\phit,\psit,\thetat,\lambdat	&	Variables dépendant du temps \rac
		\\\hline
			\verb!\xtp,\ytp,\ztp,\rtp,! \verb!\alphatp,\betatp,! \verb!\gammatp,\phitp,\psitp,! \verb!\thetatp,\lambdatp!	&	\xtp,\ytp,\ztp,\rtp,\alphatp, \betatp,\gammatp,\phitp,\psitp,\thetatp,\lambdatp	&	Dérivée de variables dépendant du temps \rac
		\\\hline
			\verb!\xp,\yp,\zp,\rp,\alphap,! \verb!\betap,\gammap,\phip,! \verb!\psip,\thetap,\lambdap!	&	\xp,\yp,\zp,\rp,\alphap, \betap,\gammap,\phip,\psip,\thetap,\lambdap	&	Identique à précédemment sans la dépendance temporelle.
		\\\hline
			\verb!\xtpp,\ytpp,\ztpp,\rtpp,! \verb!\alphatpp,\betatpp,! \verb!\gammatpp,\phitpp,! \verb!\psitpp,\thetatpp,! \verb!\lambdatpp!	&	\xtpp,\ytpp,\ztpp,\rtpp,\alphatpp, \betatpp,\gammatpp,\phitpp,\psitpp,\thetatpp,\lambdatpp	&	Dérivée seconde de variables dépendant du temps \rac
		\\\hline
			\verb!\xpp,\ypp,\zpp,\rpp,! \verb!\alphapp,\betapp,! \verb!\gammapp,\phip,! \verb!\psipp,\thetapp,! \verb!\lambdapp!	&	\xpp,\ypp,\zpp,\rpp,\alphapp, \betapp,\gammapp,\phipp,\psipp,\thetapp,\lambdapp	&	Identique à précédemment sans la dépendance temporelle.
		\\\hline
	\end{tabular}
	...
	\begin{tabular}{|p{0.35\linewidth}|p{0.3\linewidth}|p{0.3\linewidth}|}
		...
		\\\hline
			\verb!\DCallig!		&	\DCallig	&	``D'' calligraphié
		\\\hline
