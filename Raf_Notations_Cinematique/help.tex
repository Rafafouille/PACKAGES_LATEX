...
usepackage[noRaccourci]{Raf_Notations_Cinematique}
	...
	\begin{tabular}{|p{0.35\linewidth}|p{0.3\linewidth}|p{0.3\linewidth}|}
		\hline
			\textbf{Commandes}&\textbf{Rendus}&\textbf{Commentaires}
		\\\hline\hline
			\verb!\xt,\yt,\zt,\rt,\alphat,! \verb!\betat,\gammat,! \verb!\psit,\thetat!	&	\xt,\yt,\zt,\rt,\alphat, \betat,\gammat,\psit,\thetat	&	Variables dépendant du temps \rac
		\\\hline
			\verb!\xtp,\ytp,\ztp,\rtp,! \verb!\alphatp,\betatp,! \verb!\gammatp,\phitp,\psitp,! \verb!\thetatp!	&	\xtp,\ytp,\ztp,\rtp,\alphatp, \betatp,\gammatp,\phitp,\psitp,\thetatp	&	Dérivée de variables dépendant du temps \rac
		\\\hline
			\verb!\xp,\yp,\zp,\rp,\alphap,! \verb!\betap,\gammap,\phip,! \verb!\psip,\thetap!	&	\xp,\yp,\zp,\rp,\alphap, \betap,\gammap,\phip,\psip,\thetap	&	Identique à précédemment sans la dépendance temporelle.
		\\\hline
			\verb!\xtpp,\ytpp,\ztpp,\rtpp,! \verb!\alphatpp,\betatpp,! \verb!\gammatpp,\phitpp,! \verb!\psitpp,\thetatpp!	&	\xtpp,\ytpp,\ztpp,\rtpp,\alphatpp, \betatpp,\gammatpp,\phitpp,\psitpp,\thetatpp	&	Dérivée seconde de variables dépendant du temps \rac
		\\\hline
			\verb!\xpp,\ypp,\zpp,\rpp,! \verb!\alphapp,\betapp,! \verb!\gammapp,\phip,! \verb!\psipp,\thetapp!	&	\xpp,\ypp,\zpp,\rpp,\alphapp, \betapp,\gammapp,\phipp,\psipp,\thetapp	&	Identique à précédemment sans la dépendance temporelle.
		\\\hline
	\end{tabular}
