...
# -*- coding: utf-8 -*-
#
#  Copyright (c) 2018 by Nicolas Mesnier <nicolas.mesnier@gmail.com>
# 
...
examples:
    $ %(prog)s infile.tex
    $ %(prog)s infile.tex -o outfile.tex
"""

__version__   = "0.0.1"
__author__    = "Nicolas Mesnier <nicolas.mesnier@gmail.com>"
...
#
data = {
    "teXstylesPATH":"/home/lacharnay/Documents/Programmes/teXstyles",
...
# EXEoptions={
#     "latex": "",
#     "pdflatex": "--shell-escape", # pdflatex compil options
#     "dvips": "-q", # `-q` to be quiet
#     "ps2pdf": "",
#     "gs": " ".join(["-dSAFER","-dBATCH","-dNOPAUSE",
#         "-sDEVICE=pdfwrite","-dCompatibilityLevel=1.4",
#         "-dPDFSETTINGS=/printer"]),
#     }
# 
...
#  --------
# 
#     0.0.1 - 22/02/2017 (first release)
#             
# 
#  TO DO
#  -----
...
def MakeTeX(data):
    ...
    if data['doctype']=="pres":
        c.append("\\documentclass{mypresentation}")
    else:
        c.append("\\documentclass["+data['doctype']+","+data['docvers']+","+data['docdest']+"]{teXstyles}")
...
if __name__ == '__main__':# and sys.argv[0]!='' and len(sys.argv)>0:
    ...
    try:
        ...
        # parser.add_argument_group('document type')
        # *** document type
        ...
        for arg in ["docvers", "docdest", "debug"]:
            if eval('args.'+arg):
